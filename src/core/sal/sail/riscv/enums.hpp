#ifndef RISCVENUMS_HPP
#define RISCVENUMS_HPP
// every arch must define fail::sail_arch::registers::LAST_NAMED_REG_ID
// so that non-llvm translatable registers get a unique id.
