#ifndef SAILMEMORY_HPP
#define SAILMEMORY_HPP

#include "../Memory.hpp"
#include <iostream>


//TODO: does the memory injection work, if there are only blocks of memory far apart
namespace fail {
/**
 * \class SailMemoryManager
 * Represents a concrete implemenation of the abstract
 * MemoryManager to provide access to Sails memory pool.
 */
class SailMemoryManager : public MemoryManager {
   public:
    /**
     * Constructs a new MemoryManager object and initializes
     * it's attributes appropriately.
     */
    SailMemoryManager() : MemoryManager() { }
    /**
