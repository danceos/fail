...
# The 'ExternalProject_Add2_Gem5Specific' function creates a custom target to drive
# download, update/patch, configure, build, install and test steps of an
# external project:
#  ExternalProject_Add2_Gem5Specific(<name>    # Name for custom target
...
# If the PREFIX option is given to ExternalProject_Add2_Gem5Specific() or the EP_PREFIX
...
# corresponding to the source directory in which ExternalProject_Add2_Gem5Specific is
# invoked.
#
...
#
# The 'ExternalProject_Add2_Gem5Specific_Step' function adds a custom step to an external
# project:
#  ExternalProject_Add2_Gem5Specific_Step(<name> <step> # Names of project and custom step
...
define_property(DIRECTORY PROPERTY "EP_BASE" INHERITED
  ...
  FULL_DOCS
  "See documentation of the ExternalProject_Add2_Gem5Specific() function in the "
...
function(ExternalProject_Add2_Gem5Specific_Step name step)
  ...
  _ep_parse_arguments(ExternalProject_Add2_Gem5Specific_Step
...
endfunction(ExternalProject_Add2_Gem5Specific_Step)
...
function(_ep_add_mkdir_command name)
  ...
  ExternalProject_Add2_Gem5Specific_Step(${name} mkdir
...
function(_ep_add_download_command name)
  ...
  ExternalProject_Add2_Gem5Specific_Step(${name} download
    COMMENT ${comment}
    COMMAND ${cmd}
    WORKING_DIRECTORY ${work_dir}
    DEPENDS ${depends}
...
function(_ep_add_update_command name)
  ...
  ExternalProject_Add2_Gem5Specific_Step(${name} update
    COMMENT ${comment}
    COMMAND ${cmd}
    ALWAYS ${always}
    WORKING_DIRECTORY ${work_dir}
...
function(_ep_add_patch_command name)
  ...
  ExternalProject_Add2_Gem5Specific_Step(${name} patch
    COMMAND ${cmd}
    WORKING_DIRECTORY ${work_dir}
    DEPENDEES download
    )
...
function(_ep_add_configure_command name)
  ...
  ExternalProject_Add2_Gem5Specific_Step(${name} configure
    COMMAND ${cmd}
...
function(_ep_add_build_command name)
  ...
  ExternalProject_Add2_Gem5Specific_Step(${name} build
    COMMAND ${cmd}
    WORKING_DIRECTORY ${binary_dir}
    DEPENDEES configure
    )
...
function(_ep_add_install_command name)
  ...
  ExternalProject_Add2_Gem5Specific_Step(${name} install
    COMMAND ${cmd}
    WORKING_DIRECTORY ${binary_dir}
    DEPENDEES build
    )
...
function(_ep_add_test_command name)
  ...
  if(cmd_set OR before OR after)
    ...
    ExternalProject_Add2_Gem5Specific_Step(${name} test
      COMMAND ${cmd}
      WORKING_DIRECTORY ${binary_dir}
      ${dep_args}
      )
...
function(ExternalProject_Add2_Gem5Specific name)
  _ep_get_configuration_subdir_suffix(cfgdir)
  ...
  _ep_parse_arguments(ExternalProject_Add2_Gem5Specific ${name} _EP_ "${ARGN}")
...
endfunction(ExternalProject_Add2_Gem5Specific)
